                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                            placeholder="Judul" name="judul" value="{{$berita->judul ?? old('judul')}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control @error('berita') is-invalid @enderror" id="berita"
                            name="berita" value="{{$berita->berita ?? old('berita')}}"></textarea>
                    ...
                    <div class="form-group">
                        <label for="tgl_postingan">Tanggal Postingan</label>
                        <input type="datetime-local" class="form-control @error('tgl_post') is-invalid @enderror"
                            id="tgl_post" placeholder="Tanggal Postingan" name="tgl_post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('kategori_berita') is-invalid @enderror"
                                ...
                                value="{{old('kategori_berita')}}" arialabel="kategori_berita" aria-describedby="cari"
                                readonly>
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari"
                                data-bs-target="#staticBackdrop"></i>Cari Kategori Berita</button>
                        </div>
                        <div class="form-group">
